...
public class AsyncScanRearchLastTask extends AsyncMultiRequestTask {
    private String transCode = TransCode.SCAN_LAST_SERCH;
    public Map<String, String> returnMap;
    public AsyncScanRearchLastTask(Context context, Map<String, String> dataMap, Map<String, String> returnMap) {
