...
public abstract class AsyncAutoSignOut extends AsyncMultiRequestTask {
    private String transCode = TransCode.SIGN_OUT;
    public AsyncAutoSignOut(Context context, Map<String, String> dataMap) {
