...
public abstract class AsyncDownloadQPSCardBinTask extends AsyncMultiRequestTask {
    ...
    public AsyncDownloadQPSCardBinTask(Context context, Map<String, String> dataMap) {
        super(context, dataMap);
        dao = new CommonDao<>(QpsBinData.class, new DbHelper(context));
    }
    ...
    protected String[] doInBackground(String... params) {
        ...
        Object msgPacket = factory.pack(TransCode.DOWNLOAD_CARD_BIN_QPS, dataMap);
        ...
        client.syncSendSequenceData(TransCode.DOWNLOAD_CARD_BIN_QPS, (byte[]) msgPacket, handler);
        return result;
    }
